...
const About = () => {
  return (
    ...
    >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="glass-card p-10">
              ...
              <p className="font-space mb-6 leading-relaxed text-lg">
              ...
              <p className="font-space leading-relaxed text-lg">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-bebas text-5xl text-center mb-16 tracking-wider" style={{ color: 'var(--heading-color)' }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="glass-card p-8 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              <Users className="mx-auto mb-6 text-secondary" size={48} />
              <h3 className="font-bebas text-2xl mb-4 tracking-wider" style={{ color: 'var(--heading-color)' }}>COMMUNITY</h3>
            ...
            <div className="glass-card p-8 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              <Target className="mx-auto mb-6 text-secondary" size={48} />
              <h3 className="font-bebas text-2xl mb-4 tracking-wider" style={{ color: 'var(--heading-color)' }}>INNOVATION</h3>
              <p className="font-space text-sm leading-relaxed">
                Constantly pushing creative boundaries and embracing new technologies
              </p>
            </div>
            <div className="glass-card p-8 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              <Award className="mx-auto mb-6 text-secondary" size={48} />
              <h3 className="font-bebas text-2xl mb-4 tracking-wider" style={{ color: 'var(--heading-color)' }}>QUALITY</h3>
              <p className="font-space text-sm leading-relaxed">
                Premium materials and exceptional craftsmanship in every single piece
              </p>
            </div>
            <div className="glass-card p-8 text-center hover:bg-white/15 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
              <Globe className="mx-auto mb-6 text-secondary" size={48} />
              <h3 className="font-bebas text-2xl mb-4 tracking-wider" style={{ color: 'var(--heading-color)' }}>SUSTAINABILITY</h3>
              <p className="font-space text-sm leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="glass-card p-10 text-center hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <p className="font-space mb-6 text-lg font-medium" style={{ color: 'var(--heading-color)' }}>CEO & Founder</p>
              <p className="font-space text-sm leading-relaxed">
            ...
            <div className="glass-card p-10 text-center hover:bg-white/10 transition-all duration-300 hover:scale-105">
              ...
              <p className="font-space mb-6 text-lg font-medium" style={{ color: 'var(--heading-color)' }}>CEO</p>
              <p className="font-space text-sm leading-relaxed">
