...
const Terms = () => {
  return (
    ...
    // Odstranjeni so tudi fiksni razredi za barvo ozadja in besedila.
    <div 
    ...
    >
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center">
          ...
          <p className="font-space max-w-2xl mx-auto text-lg leading-relaxed">
        ...
        <div className="glass-card p-8 md:p-12 rounded-2xl shadow-2xl space-y-4">
          ...
          <p className="font-space leading-relaxed">
        ...
        {/* Footer */}
        <p className="text-sm text-center font-space pt-6">
