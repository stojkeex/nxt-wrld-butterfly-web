...
const BlogSection = () => (
  <section className="py-20 px-4">
    <div className="max-w-6xl mx-auto">
      <h2 className="font-bebas text-5xl md:text-6xl text-center mb-16 tracking-wider" style={{ color: 'var(--heading-color)' }}>
...
const Home = () => {
  return (
    ...
    // To zagotavlja, da bodo nastavitve iz menija vedno uporabljene.
    <div 
    ...
    >
      ...
      <section className="min-h-screen flex items-center justify-center px-4 relative">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="font-sans-serif text-8xl md:text-9xl lg:text-[12rem] tracking-wider mb-8" style={{ color: 'var(--heading-color)' }}>
            <span className="text-gradient-primary">NXT</span>WRLD
          </h1>
          {/* POPRAVEK: Odstranjen razred text-gray-300, ker barvo zdaj nadzira starševski div. */}
          <p className="text-xl md:text-2xl mb-12 font-space max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass-card p-8 text-center hover:bg-white/10 transition-colors">
              ...
              <h3 className="font-bebas text-2xl mb-4 tracking-wider" style={{ color: 'var(--heading-color)' }}>INNOVATIVE DESIGN</h3>
            ...
            <div className="glass-card p-8 text-center hover:bg-white/10 transition-colors">
              ...
              <h3 className="font-bebas text-2xl mb-4 tracking-wider" style={{ color: 'var(--heading-color)' }}>PREMIUM QUALITY</h3>
              <p className="font-space">
            ...
            <div className="glass-card p-8 text-center hover:bg-white/10 transition-colors">
              ...
              <h3 className="font-bebas text-2xl mb-4 tracking-wider" style={{ color: 'var(--heading-color)' }}>LIMITED DROPS</h3>
              <p className="font-space">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-12">
            <h2 className="font-bebas text-4xl md:text-5xl mb-6 tracking-wider" style={{ color: 'var(--heading-color)' }}>
              JOIN THE <span className="text-gradient-primary">REVOLUTION</span>
            </h2>
            <p className="text-xl mb-8 font-space">
